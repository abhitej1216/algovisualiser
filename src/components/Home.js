            ...
            <div className="back">
                ...
                <div class="box title">
                    <div className="container-fluid solid">
                        <ul className="links">
                            <li onClick={() => window.open("https://github.com/abhitej1216", "_blank")}>
                                <i>
                                    <Github />
                                </i>
                            </li>
                            <li onClick={() => window.open("https://www.linkedin.com/in/abhijeet-chauhan1216/", "_blank")}>
                                <i>
                                    <LinkedIn />
                                </i>
                            </li>
                ...
                <h1 className="main-title center">
                    ...
                    ALGORITHM <i style={{ color: "var(--home-color)" }}><br></br>VISUALIZER</i>
                </h1>
                <div>
                ...
                <ul class="list-inline mt-8" style={{ display: "block", poition: "relative" }}>
                    {this.state.problems.map(element =>
                        <li className="list-inline-item ml-4 mr-4 mb-4" style={{ cursor: "pointer" }} onClick={() => window.location.href = element.link}>
